...
UNS8 writeNetworkDictWithCsS (CO_Data* d, UNS8 nodeId, UNS16 index,
		       UNS8 subIndex, UNS32 count, UNS8 dataType, void *data, UNS8 useBlockMode, UNS8 sdoCsS);
...
UNS8 writeNetworkDictCallBackWithCsS (CO_Data* d, UNS8 nodeId, UNS16 index,
		       UNS8 subIndex, UNS32 count, UNS8 dataType, void *data, SDOCallback_t Callback, UNS8 useBlockMode, UNS8 sdoCsS);
